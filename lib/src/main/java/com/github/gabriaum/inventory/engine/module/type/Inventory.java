...
import com.github.gabriaum.inventory.engine.configuration.InventoryConfiguration;
import com.github.gabriaum.inventory.engine.configuration.layout.Layout;
import com.github.gabriaum.inventory.engine.controller.list.LayoutController;
import com.github.gabriaum.inventory.engine.sound.SoundType;
            ...
            while (layoutIterator.hasNext()) {
                ...
                switch (layout.getFrame()) {
                    ...
                    case NEXT_PAGE: {
                        ...
                        if (Math.ceil(source.size() / itemsPerPage) + 1 > currentPage) {
                    ...
                    case PREVIOUS_PAGE: {
                        ...
                        if (currentPage > 1)
                            item = new ItemHelper(Material.ARROW).name("§aPágina anterior")
                                    .click(event -> {
                                        currentPage--;
